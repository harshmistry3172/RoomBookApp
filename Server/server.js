...
// MongoDB Connection
mongoose.connect('mongodb://0.0.0.0:27017/roomBookingDB') // TODO: make this a .env variable
.then(() => console.log('MongoDB connected'))
.catch(err => console.log(err));

var store = new MongoDBStore({
  uri: 'mongodb://0.0.0.0:27017/roomBookingDB', // TODO: make this a .env variable
  collection: 'Sessions'
});
